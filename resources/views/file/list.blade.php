    ...
    <div class="col-md-10">
        <div class="card">
            <div class="card-header text-right">
                <button class="btn btn-success btn-sm" data-toggle="modal" data-target="#uploadFileModal"><i class="fas fa-plus"></i> ADD </button>
            </div>
            <div class="card-header">
                <h2 class="card-title">NAME: <b>{{ strtoupper($patient->lname) }} {{ strtoupper($patient->fname) }} {{ isset($patient->ext_name) ? strtoupper($patient->ext_name) : '' }} {{ strtoupper($patient->mname) }}</b></h2>
            ...
            <div class="table-responsive p-0" style="height: 400px;">
                <table class="table table-head-fixed text-nowrap">
                    ...
                    <tr id="tr-file-{{ $file->id }}">
                        ...
                        <td>
                            <div class="dropdown">
                                <button class="btn" type="button" id="fileOptions-{{ $file->id }}" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
